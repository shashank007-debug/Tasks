...
public class Runner {
    public static void main(String[] args) {
        ...
        eg.invokeAllInheritedMethods();
        eg.checkAndCast(eg);
        eg.checkAndCast(new Guitar());
        System.out.println("------------------------------");
        ElectricHarp eh = new ElectricHarp();
        eh.invokeAllInheritedMethods();
        eh.checkAndCast(eh);
        eh.checkAndCast(new Harp());
        System.out.println("------------------------------");
        GrandPiano gp = new GrandPiano();
        gp.invokeAllInheritedMethods();
        gp.checkAndCast(gp);
        gp.checkAndCast(new Piano());
        System.out.println("------------------------------");
        AltoSaxophone as = new AltoSaxophone();
        as.invokeAllInheritedMethods();
        as.checkAndCast(as);
        as.checkAndCast(new Saxophone());
        System.out.println("------------------------------");
        BassTrombone bt = new BassTrombone();
        bt.invokeAllInheritedMethods();
        bt.checkAndCast(bt);
        bt.checkAndCast(new Trombone());
        System.out.println("------------------------------");
        JazzTrumpet jt = new JazzTrumpet();
        jt.invokeAllInheritedMethods();
        jt.checkAndCast(jt);
        jt.checkAndCast(new Trumpet());
        System.out.println("------------------------------");
        ElectricViolin ev = new ElectricViolin();
        ev.invokeAllInheritedMethods();
        ev.checkAndCast(ev);
        ev.checkAndCast(new Violin());
        System.out.println("------------------------------");
        ElectricCello ec = new ElectricCello();
        ec.invokeAllInheritedMethods();
        ec.checkAndCast(ec);
        ec.checkAndCast(new Cello());
        System.out.println("------------------------------");
        ElectricDrumKit edk = new ElectricDrumKit();
        edk.invokeAllInheritedMethods();
        edk.checkAndCast(edk);
        edk.checkAndCast(new Drums());
        System.out.println("------------------------------");
        BambooFlute bf = new BambooFlute();
        bf.invokeAllInheritedMethods();
        bf.checkAndCast(bf);
        bf.checkAndCast(new Flute());
        System.out.println("------------------------------");
    }
}